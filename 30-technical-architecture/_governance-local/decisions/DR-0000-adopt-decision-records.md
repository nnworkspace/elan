...
| Status        | Accepted              |
| Date          | 2025-12-29            |
| Deciders      | Lead System Architect |
| Supersedes    | none                  |
| Superseded by | none                  |

## Context and problem statement

The architecture layer accumulates decisions that are costly to reverse and specific to this layer: where component boundaries are drawn, which architectural views are maintained, how privacy and security zones are partitioned. The reasoning behind such decisions is easily lost once the discussion that produced it has faded. The project has adopted decision records as the standard mechanism for preserving that reasoning (see [`PDR-0000`](../../../00-project-governance/decisions/PDR-0000-adopt-decision-records.md)), and this layer needs a local place to keep the records that belong to it.
