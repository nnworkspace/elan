...
- operational and non-functional guarantees are met,
...
- a claim about system behaviour (functional, security-related, or operational),
...
- **Performance and capacity guarantees**  
  Latency, throughput, and concurrency expectations expressed as assertions,
  not as tool-specific benchmarks.

- **Availability and resilience guarantees**  
...
The following do **not** belong here and should live close to the code or tooling instead:
...
Every artefact in this folder SHOULD reference one or more specification identifiers from the `60-specifications/` layer.
...
The `90-reports/` folder contains **derived views** of this evidence. This folder contains the **source assertions**.
