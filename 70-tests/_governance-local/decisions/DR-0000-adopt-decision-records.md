...
# DR-0000: Adopt decision records for the tests and evidence layer

| Field         | Value          |
| :------------ | :------------- |
| Status        | Accepted       |
| Date          | 2025-12-29     |
| Deciders      | System quality |
| Supersedes    | none           |
| Superseded by | none           |

## Context and problem statement

The tests and evidence layer accumulates decisions that are costly to reverse and specific to this layer: how claims and evidence are organised, which assurance categories are maintained, the decision to keep artefacts tool-neutral. The reasoning behind such decisions is easily lost once the discussion that produced it has faded. The project has adopted decision records as the standard mechanism for preserving that reasoning (see [`PDR-0000`](../../../00-project-governance/decisions/PDR-0000-adopt-decision-records.md)), and this layer needs a local place to keep the records that belong to it.
