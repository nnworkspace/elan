...
<!--
TEMPLATE: layer-local decision record (DR) for the System Tests and Evidence layer.
...
This template is local to the System Tests and Evidence layer and may be tailored to its nature:
