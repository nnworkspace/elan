...
| :--- | :--- | :--- |
| **LIQ-01** | **Reverse Waterfall (Auto-Funding)** | [`liquidity-and-waterfall.md`](../../30-rulebook/liquidity-and-waterfall.md) |
| **LIQ-02** | **Waterfall (Defunding)** | [`liquidity-and-waterfall.md`](../../30-rulebook/liquidity-and-waterfall.md) |
| **LIQ-03** | **Zero-Holding Option** | [`liquidity-and-waterfall.md`](../../30-rulebook/liquidity-and-waterfall.md) |
| **LIQ-04** | **Holding Limits** | [`onboarding-rules.md`](../../30-rulebook/onboarding-rules.md) |
...
2.  **Dependency Validation (Linting):**
    ...
    - Check that this version matches the `version` field in `30-rulebook/manifest.yaml`.
    - Parse **Section 3.2** to find the `@arch` tag.
    - Check that this version matches the `version` field in `50-system-architecture/manifest.yaml`.
