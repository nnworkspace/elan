...
<!--
TEMPLATE: layer-local decision record (DR) for the Specifications layer.
...
This template is local to the Specifications layer and may be tailored to its nature:
