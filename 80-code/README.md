...
The top-level folders under `80-code/` represent **technical components**,
...
This repository deliberately uses **subfolders under `80-code/`** to illustrate those components **side by side**, for pedagogical purposes.
...
Each component under `80-code/` represents an independently owned institutional component.
...
3. **Component-local documentation (`docs/`)**  
   ...
   This folder MUST NOT duplicate:
        - global architecture (`50-system-architecture/`),
        - specifications (`60-specifications/`),
