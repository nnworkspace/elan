...
* **Upstream Rule Reference:** [`30-rulebook/actors-and-roles.md`](../30-rulebook/actors-and-roles.md)
* **Responsibility:**
...
* **Upstream Rule Reference:** [`30-rulebook/liquidity-and-waterfall.md`](../30-rulebook/liquidity-and-waterfall.md)
...
This architecture implies the existence of the following high-level interfaces (to be specified in `60-specifications`):
