...
<!--
TEMPLATE: layer-local decision record (DR) for the Business Architecture layer.
...
This template is local to the Business Architecture layer and may be tailored to its nature:
