...
## Purpose
This document captures **what liquidity management must achieve** from the user's perspective: keeping a user's digital euro balance usable for payments and within the holding limit, with funding and defunding from and to a linked non-digital-euro payment account. It is the upstream input that the rulebook codifies into the binding liquidity rules (`30-rulebook/liquidity-and-waterfall.md`, rules `LIQ-*`).
...
These requirements are made binding by the liquidity rules in [`30-rulebook/liquidity-and-waterfall.md`](../30-rulebook/liquidity-and-waterfall.md):
