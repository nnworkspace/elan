...
It serves as the master inventory for the system. Every piece of code or infrastructure in the `80-code` layer must map to at least one of these components.
