...
<!--
TEMPLATE: layer-local decision record (DR) for the System Architecture layer.
...
This template is local to the System Architecture layer and may be tailored to its nature:
