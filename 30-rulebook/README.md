...
The Rulebook layer acts as the **bridge** between the Legislative Framework (`10-legal-framework`) and the Technical Specifications (`60-specifications`).
...
- **Upstream (`10-legal-framework` & `20-requirements`):**
  Rules here derive their authority from the external Legal Framework, and give operational effect to the user journeys and functional requirements defined in `20-requirements`.
...
- **Downstream (`40-business-architecture`, `50-system-architecture` & `60-specifications`):**
