...
This folder (`100-automation`) represents the **Active Governance Layer** of the project workbench.

Unlike static documentation (00-60) or passive code (80), this directory contains the **machinery** that actively enforces rules, verifies compliance, and generates evidence.

## Philosophy: "The Factory"

If `00-project-governance` is the **Law**, `100-automation` is the **Police**. It transforms "Bureaucracy" from a paper-based bottleneck into an automated enabler.
...
- **Role**: Parses human-readable specifications (`60-specifications`), builds dependency graphs, and calculates the "Blast Radius" of changes to alert experts only when necessary.
...
- **Output**: Generates Evidence (`90-reports`) and Deployable Artifacts.
