...
<!--
TEMPLATE: layer-local decision record (DR) for the Automation & Governance Engineering layer.
...
This template is local to the Automation & Governance Engineering layer and may be tailored to its nature:
...
The situation that forces a decision, and the constraints that apply, as understood today. Frozen at acceptance.
...
- <concrete condition under which to revisit this decision>
