...
# 100-automation: The Automation Workstream
...
*   `pipelines/02-integration-orchestration.yaml`: **The Orchestrator**.
    ...
    *   Executes the Critical Conformance Suite (70-tests).

*   `pipelines/03-evidence-and-reporting.yaml`: **The Notary**.
    *   Collects results, verifies chain-of-custody, and generates the `90-reports/`.
